...
-(void)layoutSubviews{
    ...
    if (_flag_milestone_type==0) {
        [_ilb_status_desc setFrame:CGRectMake(_ipic_desc_status.frame.origin.x, _ilb_status_desc.frame.origin.y, 270, _ilb_status_desc.frame.size.height)];
        [_ilb_status_remark setFrame:CGRectMake(_ipic_desc_status.frame.origin.x,_ilb_status_remark.frame.origin.y, 270, _ilb_status_remark.frame.size.height)];
